...
from keras.layers import Flatten, Dense, Input, merge, Convolution2D, Deconvolution2D, Activation
...
def create_model(**kwargs):
	...
	GAN_input = Input(shape=(num_input_channels, image_width, image_height), name='GAN_input')
...
def create_generator(**kwargs):
	...
	##### encoder
	encoder_input = Input(shape=(num_input_channels, image_width, image_height), name='generator_input')

	### BLOCK 1
	encoder_1 = Convolution2D(nb_filter=num_kernels, init='he_normal',
	...
	encoder_2 = Convolution2D(nb_filter=num_kernels * filter_multiplier, init='he_normal',
								nb_row=kernel_width, nb_col=kernel_height, border_mode='same', 
	...
	encoder_3 = Convolution2D(nb_filter=num_kernels * filter_multiplier, init='he_normal',
								nb_row=kernel_width, nb_col=kernel_height, border_mode='same', 
	...
	encoder_4 = Convolution2D(nb_filter=num_kernels * filter_multiplier, init='he_normal',
								nb_row=kernel_width, nb_col=kernel_height, border_mode='same', 
	...
	encoder_5 = Convolution2D(nb_filter=num_kernels * filter_multiplier, init='he_normal',
								nb_row=kernel_width, nb_col=kernel_height, border_mode='same', 
	...
	encoder_6 = Convolution2D(nb_filter=num_kernels * filter_multiplier, init='he_normal',
								nb_row=kernel_width, nb_col=kernel_height, border_mode='same', 
	...
	encoder_7 = Convolution2D(nb_filter=num_kernels * filter_multiplier, init='he_normal',
								nb_row=kernel_width, nb_col=kernel_height, border_mode='same', 
	...
	encoder_8 = Convolution2D(nb_filter=num_kernels * filter_multiplier, init='he_normal',
	...
	_decoder_1 = Deconvolution2D(nb_filter=num_kernels * filter_multiplier, init='he_normal',
									   nb_row=kernel_width, nb_col=kernel_height, border_mode='same',
	...
	_decoder_2 = Deconvolution2D(nb_filter=num_kernels * filter_multiplier, init='he_normal',
									   nb_row=kernel_width, nb_col=kernel_height, border_mode='same',
									   output_shape=output_shape,
	...
	_decoder_3 = Deconvolution2D(nb_filter=num_kernels * filter_multiplier, init='he_normal',
									   nb_row=kernel_width, nb_col=kernel_height, border_mode='same',
									   output_shape=output_shape,
	...
	_decoder_4 = Deconvolution2D(nb_filter=num_kernels * filter_multiplier, init='he_normal',
									   nb_row=kernel_width, nb_col=kernel_height, border_mode='same',
									   output_shape=output_shape,
	...
	_decoder_5 = Deconvolution2D(nb_filter=num_kernels * filter_multiplier, init='he_normal',
									   nb_row=kernel_width, nb_col=kernel_height, border_mode='same',
									   output_shape=output_shape,
	...
	_decoder_6 = Deconvolution2D(nb_filter=num_kernels * filter_multiplier, init='he_normal',
									   nb_row=kernel_width, nb_col=kernel_height, border_mode='same',
									   output_shape=output_shape,
	...
	_decoder_7 = Deconvolution2D(nb_filter=num_kernels * filter_multiplier, init='he_normal',
									   nb_row=kernel_width, nb_col=kernel_height, border_mode='same',
									   output_shape=output_shape,
	...
	decoder_8 = Deconvolution2D(nb_filter=num_output_channels, init='he_normal',
									   nb_row=kernel_width, nb_col=kernel_height, border_mode='same',
									   output_shape=output_shape,
									   subsample=(kernel_stride, kernel_stride))(decoder_8)
	# Output is num_output_channels x image_width x image_height

	decoder_output = Activation('tanh', name='generator_output')(decoder_8)
...
def create_discriminator(**kwargs):
	...
	discriminator_input = Input(shape=(num_input_channels, image_width, image_height), name='discriminator_input')

	### BLOCK 1
	discriminator_1 = Convolution2D(nb_filter=num_kernels, init='he_normal',
					  nb_row=kernel_width, nb_col=kernel_height, border_mode='same', 
	...
	### BLOCK 2
	filter_multiplier = 2 # used to increase the number of convolutional filters to use
	discriminator_2 = Convolution2D(nb_filter=num_kernels * filter_multiplier, init='he_normal',
					  nb_row=kernel_width, nb_col=kernel_height, border_mode='same', 
	...
	discriminator_3 = Convolution2D(nb_filter=num_kernels * filter_multiplier, init='he_normal',
					  nb_row=kernel_width, nb_col=kernel_height, border_mode='same', 
	...
	discriminator_4 = Convolution2D(nb_filter=num_kernels * filter_multiplier, init='he_normal',
					  nb_row=kernel_width, nb_col=kernel_height, border_mode='same', 
	...
	### BLOCK 6
	filter_multiplier = 2 # used to increase the number of convolutional filters to use
	discriminator_5 = Convolution2D(nb_filter=1, init='he_normal',
					  nb_row=kernel_width, nb_col=kernel_height, border_mode='same', 
	...
	discriminator_5 = Flatten()(discriminator_5)
	discriminator_output = Dense(1, activation='softmax', name='discriminator_output')(discriminator_5)
	# Output is 1
